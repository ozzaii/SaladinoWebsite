import { PngOptions, JpegOptions, WebpOptions, AvifOptions } from 'sharp';
...
type DefaultImageParser = (src: string) => ParsedImageInfo;
type SourceImageParser = (determinerProps: {
    src: string;
