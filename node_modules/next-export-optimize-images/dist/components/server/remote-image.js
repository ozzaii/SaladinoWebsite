...
// src/components/server/remote-image.tsx
var remote_image_exports = {};
__export(remote_image_exports, {
  default: () => remote_image_default
});
module.exports = __toCommonJS(remote_image_exports);
...
// src/components/server/remote-image.tsx
var import_image = __toESM(require("../client/image"));
var config = getConfig_default();
var RemoteImage = (0, import_react.forwardRef)(({ src, ...props }, forwardedRef) => {
  if (process.env.NODE_ENV === "production") {
    ...
    for (const width of allSizes) {
      ...
      (0, import_fs_extra.appendFileSync)((0, import_node_path.join)(process.cwd(), ".next/next-export-optimize-images-list.nd.json"), `${JSON.stringify(json)}
`);
    }
  }
  return /* @__PURE__ */ import_react.default.createElement(import_image.default, { ...props, src, ref: forwardedRef });
});
RemoteImage.displayName = "RemoteImage";
var remote_image_default = RemoteImage;
